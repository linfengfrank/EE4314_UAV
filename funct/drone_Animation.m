...
gate_length = 0.8;
gate_width  = 0.6; 
gate_vertice0= [ 0, -gate_width/2.0,  gate_length/2.0;
                 0,  gate_width/2.0,  gate_length/2.0;
                 0,  gate_width/2.0, -gate_length/2.0;
                 0, -gate_width/2.0, -gate_length/2.0];

gate_vertice = rotx(-0) * gate_vertice0' + gate_center'; 
